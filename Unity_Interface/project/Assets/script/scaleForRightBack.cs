...
public class scaleForRightBack : MonoBehaviour {
	...
	void setScale(){
		...
		GetComponent<GUITexture>().pixelInset = new Rect(Screen.width/2 - Screen.width*0.2f, -Screen.height/2, Screen.width*0.2f, Screen.height);
	}
}
